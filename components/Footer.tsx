    ...
    <footer className="bg-slate-900 text-white" itemScope itemType="https://schema.org/Organization">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div>
            <div className="flex items-center gap-2.5 mb-4">
              ...
              <div>
                <h3 className="text-lg font-bold" itemProp="name">PHANOMPHRAI รับสร้างบ้าน</h3>
                <p className="text-slate-400 text-xs">บริษัทรับเหมาก่อสร้างครบวงจร</p>
              </div>
            </div>

            <p className="text-slate-400 text-xs leading-relaxed mb-4" itemProp="description">
              <strong>รับสร้างบ้าน</strong> ต่อเติมบ้าน <strong>รีโนเวทบ้าน</strong> ออกแบบบ้าน 
              งานเหมาก่อสร้าง <strong>สร้างบ้านราคาถูก</strong> คุณภาพดี ประสบการณ์กว่า 10 ปี 
              รับงานทั่วประเทศ กรุงเทพ ปริมณฑล และต่างจังหวัด
            </p>

            {/* SEO Keywords */}
            <div className="flex flex-wrap gap-1.5 mb-4">
              {['รับสร้างบ้าน', 'ต่อเติมบ้าน', 'รีโนเวท', 'ออกแบบบ้าน'].map((tag) => (
          ...
          <div>
            ...
            <address className="not-italic space-y-2.5 text-xs" itemProp="address" itemScope itemType="https://schema.org/PostalAddress">
              <p className="text-slate-400" itemProp="streetAddress">57/11 ถ.เฉลิมพระเกียรติ 72 ต.บางปะกอก</p>
              <p className="text-slate-400">
                <span itemProp="addressLocality">กรุงเทพมหานคร</span> <span itemProp="postalCode">10540</span>
              </p>

              <div className="pt-2 space-y-2">
                <a href="tel:0922620227" className="flex items-center gap-2 text-white hover:text-blue-400 transition-colors" itemProp="telephone">
                ...
                <a href="https://line.me/ti/p/~@phanomphrai" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-white hover:text-green-400 transition-colors">
            ...
            <div className="flex gap-2 mt-4">
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="w-8 h-8 bg-slate-800 hover:bg-blue-600 rounded-lg flex items-center justify-center transition-colors">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </a>
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-8 h-8 bg-slate-800 hover:bg-pink-600 rounded-lg flex items-center justify-center transition-colors">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <div className="mt-4 pt-4 border-t border-slate-800">
              <p className="text-xs text-slate-500 leading-relaxed">
                บริการ: สร้างบ้านใหม่ | ต่อเติมบ้าน | รีโนเวทบ้าน | ออกแบบบ้าน | งานโครงสร้าง
              </p>
            </div>
          </div>
      ...
      <div className="border-t border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col sm:flex-row justify-between items-center text-xs text-slate-500 gap-3">
          <p>© {new Date().getFullYear()} PHANOMPHRAI รับสร้างบ้าน - บริษัทรับเหมาก่อสร้างคุณภาพ</p>
