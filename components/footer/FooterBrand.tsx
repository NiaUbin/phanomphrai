  ...
  return (
    <div>
      <div className="flex items-center gap-3 mb-4">
        <div className="w-10 h-10 bg-secondary rounded-lg flex items-center justify-center shadow-lg shadow-orange-500/20">
        ...
        <div>
          <h3 className="text-lg font-bold text-white" itemProp="name">{companyName}</h3>
          <p className="text-secondary text-xs font-medium tracking-wide">{tagline}</p>
        </div>
      </div>
      {showDescription && description && (
        <p className="text-slate-300 text-xs leading-relaxed mb-4 font-light" itemProp="description">
          {description}
        </p>
      )}
      <div className="text-xs text-slate-300 flex items-center gap-1 font-medium">
